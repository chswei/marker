...
def convert_pdf_to_markdown(pdf_path, output_dir="output_markdown"):
    ...
    try:
        ...
        if os.path.exists(output_filepath):
            ...
            print(f"Conversion process completed, but the expected output file was not found: {output_filepath}")
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python convert.py <path_to_pdf_file>")
        sys.exit(1)

    pdf_file_path = sys.argv[1]
    convert_pdf_to_markdown(pdf_file_path)
